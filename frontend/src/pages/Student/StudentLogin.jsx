  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 to-white">
      <form onSubmit={handleSubmit} className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-md">
        <h2 className="text-3xl font-extrabold text-center text-blue-600 mb-8">Welcome Back</h2>
        ...
        <div className="text-center mt-6">
          ...
          <button
            ...
            className="ml-2 text-sm text-blue-700 hover:underline cursor-pointer"
          >
            Sign Up
          </button>
        </div>
